  ...
  <StdListContainer>
      ...
      <el-form :model="listForm" inline class="flex justify-between">
        <div>
          ...
          <el-form-item label="可见性策略 ADD、EDIT、LIST_QUERY、LIST_VIEW">
            <el-input v-model="listForm.policyCrudJson" placeholder="输入可见性策略 ADD、EDIT、LIST_QUERY、LIST_VIEW" clearable />
          </el-form-item>
          ...
          <el-form-item label="显示策略 0:文本框 1:文本域 2:下拉 3:单 4:多 5:LD 6:LDT">
            <el-input v-model.number="listForm.policyView" placeholder="输入显示策略 0:文本框 1:文本域 2:下拉 3:单 4:多 5:LD 6:LDT" clearable />
          </el-form-item>
    ...
    <StdListAreaTable>
      <el-table :data="listData" stripe v-loading="listLoading" border height="100%">
        ...
        <el-table-column prop="policyCrudJson" label="可见性策略 ADD、EDIT、LIST_QUERY、LIST_VIEW" min-width="120" show-overflow-tooltip />
        <el-table-column prop="policyQuery" label="查询策略 0:等于" min-width="120" show-overflow-tooltip />
        <el-table-column prop="policyView" label="显示策略 0:文本框 1:文本域 2:下拉 3:单 4:多 5:LD 6:LDT" min-width="120" show-overflow-tooltip />
    ...
    >
      ...
      >
        ...
        <el-form-item label="可见性策略 ADD、EDIT、LIST_QUERY、LIST_VIEW" prop="policyCrudJson">
          <el-input v-model="modalForm.policyCrudJson" placeholder="请输入可见性策略 ADD、EDIT、LIST_QUERY、LIST_VIEW" clearable />
        </el-form-item>
        ...
        <el-form-item label="显示策略 0:文本框 1:文本域 2:下拉 3:单 4:多 5:LD 6:LDT" prop="policyView">
          <el-input v-model.number="modalForm.policyView" placeholder="请输入显示策略 0:文本框 1:文本域 2:下拉 3:单 4:多 5:LD 6:LDT" clearable />
        </el-form-item>
...
import PolyTemplateFieldService from "@/views/polyTemplateField/service/PolyTemplateFieldService.ts";
...
// 列表管理打包
const { listForm, listData, listTotal, listLoading, loadList, resetList, removeList } = PolyTemplateFieldService.usePolyTemplateFieldList();

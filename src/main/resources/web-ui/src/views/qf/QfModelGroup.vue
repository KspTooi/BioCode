      ...
      <el-form :model="listForm" inline class="flex justify-between">
        <div>
          <el-form-item label="组名称">
            <el-input v-model="listForm.name" placeholder="输入组名称" clearable />
          </el-form-item>
          <el-form-item label="组编码">
            <el-input v-model="listForm.code" placeholder="输入组编码" clearable />
          </el-form-item>
        </div>
        <el-form-item>
    ...
    >
      ...
      >
        <el-form-item label="组名称" prop="name">
          <el-input v-model="modalForm.name" placeholder="请输入组名称" clearable :maxlength="80" show-word-limit />
        </el-form-item>
        <el-form-item label="组编码" prop="code">
          <el-input v-model="modalForm.code" placeholder="请输入组编码" clearable :maxlength="32" show-word-limit />
        </el-form-item>
...
const { modalVisible, modalLoading, modalMode, modalForm, modalRules, openModal, resetModal, submitModal } =
  QfModelGroupService.useQfModelGroupModal(modalFormRef, loadList);
</script>

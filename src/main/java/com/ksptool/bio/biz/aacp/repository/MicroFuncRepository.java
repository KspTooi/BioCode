...
@Repository
public interface MicroFuncRepository extends JpaRepository<AacpFuncPo, Long> {
    ...
    @Query("""
            ...
            """)
    Page<AacpFuncPo> getMicroFuncList(@Param("po") AacpFuncPo po, Pageable pageable);
    ...
    @Query("""
            ...
            ORDER BY u.createTime DESC
            """)
    List<AacpFuncPo> getMicroFuncListByCapIds(@Param("capIds") Collection<Long> capIds);

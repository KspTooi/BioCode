...
/**
 * 这是用于SpringDataJPA的转换器，它负责将PO中的List<CustomizeTagJson>类型转换为数据库中的JSON字符串，
 * 并将数据库中的JSON字符串转换回PO中的List<CustomizeTagJson>类型。
 * <p>
 * 使用方式:
...
public class ListCTJConv implements AttributeConverter<List<CustomizeTagJson>, String> {
    ...
    /**
     * 将List<CustomizeTagJson>类型转换为数据库中的JSON字符串
     */
    @Override
    ...
    /**
     * 将数据库中的JSON字符串转换回PO中的List<CustomizeTagJson>类型
     */
    @Override

    ...
    >
      ...
      >
        ...
        <el-form-item label="菜单包编码" prop="code">
          <el-input v-model="modalForm.code" placeholder="请输入菜单包编码" clearable :maxlength="16" show-word-limit />
        </el-form-item>
...
import PackageService from "@/views/package/service/PackageService.ts";

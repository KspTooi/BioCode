  ...
  <StdListContainer>
    ...
    <StdListAreaTable>
      <el-table :data="listData" stripe v-loading="listLoading" border height="100%">
        ...
        <el-table-column prop="name" label="微函数名称" min-width="120" show-overflow-tooltip />
        <el-table-column prop="code" label="微函数标识" min-width="120" show-overflow-tooltip />
        <el-table-column prop="description" label="意图词" min-width="120" show-overflow-tooltip />
    ...
    >
      ...
      >
        <el-form-item label="微函数名称" prop="name">
          <el-input v-model="modalForm.name" placeholder="请输入微函数名称" clearable :maxlength="40" show-word-limit />
        </el-form-item>
        <el-form-item label="微函数标识" prop="code">
          <el-input v-model="modalForm.code" placeholder="请输入微函数标识" clearable :maxlength="32" show-word-limit />
        </el-form-item>
        <el-form-item label="意图词" prop="description">
          <el-input v-model="modalForm.description" placeholder="请输入意图词" clearable :maxlength="1000" show-word-limit />
        </el-form-item>
        <el-form-item label="入参规范" prop="schema">
          <el-input v-model="modalForm.schema" placeholder="请输入入参规范" clearable />
        </el-form-item>
        <el-form-item label="调用目标Bean" prop="target">
          <el-input v-model="modalForm.target" placeholder="请输入调用目标Bean" clearable :maxlength="1000" show-word-limit />
        </el-form-item>
...
import AacpFuncService from "@/views/aacpFunc/service/AacpFuncService.ts";
